            ...
            <div class="lg:col-span-2 space-y-10">
                ...
                <div>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden relative group">
                        ...
                        <div class="absolute bottom-0 left-0 w-full bg-linear-to-t from-gray-900 to-transparent p-4 pt-10">
                ...
                <div class="bg-white rounded-xl shadow-xl border border-gray-100 p-6 lg:sticky lg:top-8">
                    ...
                    <div class="space-y-4 font-noto">
                        ...
                        <div class="flex items-start gap-3 pb-3 border-b border-gray-100 last:border-0">
                            <img src="https://placehold.co/100x100/10b981/ffffff?text=Gazebo" class="w-16 h-16 rounded-md object-cover shrink-0">
                            <div class="flex-1">
                        ...
                        <!-- Item 2: Karaoke -->
                        <div class="flex items-start gap-3 pb-3 border-b border-gray-100 last:border-0">
                            <img src="https://placehold.co/100x100/059669/ffffff?text=Mic" class="w-16 h-16 rounded-md object-cover shrink-0">
                            <div class="flex-1">
                        ...
                        <!-- Item 3: Karcis -->
                        <div class="flex items-start gap-3 pb-3 border-b border-gray-100 last:border-0">
                            <div class="w-16 h-16 rounded-md bg-green-50 flex items-center justify-center shrink-0 text-green-600">
                        ...
                        <div class="flex items-start gap-3 last:border-0">
                            <img src="https://placehold.co/100x100/34d399/ffffff?text=Ban" class="w-16 h-16 rounded-md object-cover shrink-0">
                            <div class="flex-1">
